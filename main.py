...
def sendmail(name, Id, passwd, to, subject) -> IO:
...
def engine():
    ...
    while True:
        ...
        if manager.lower() in ("view", "show"):
            ...
            if manager[1].lower()=="dad":
                if len(manager)==4:
                    sendmail(details[2], details[3], details[4], "malhotrabd22@gmail.com", manager[3])
                    ...
                    for i in manager[3:]:
                        if i==manager[-1]:
                            ...
                            i += " "
                            sub += i
                    sendmail(details[2], details[3], details[4], "malhotrabd22@gmail.com", sub)

            elif manager[1].lower()=="me":
                if len(manager)==4:
                    sendmail(details[2], details[3], details[4], details[3], manager[3])
                    ...
                    for i in manager[3:]:
                        if i==manager[-1]:
                            ...
                            i += " "
                            sub += i
                    sendmail(details[2], details[3], details[4], details[3], sub)
